...
<template>
  <div class="dropdown dropdown-hover dropdown-end">
    <label tabindex="0" class="btn btn-sm btn-info m-1 lowercase truncate !inline-flex text-xs md:!text-sm">
    ...
    <div tabindex="0" class="dropdown-content menu shadow p-2 bg-base-300 rounded w-52 md:!w-64 overflow-auto">
      <label v-if="!walletStore?.currentAddress" for="PingConnectWallet" class="btn btn-sm btn-info">
