...
<template>
  <div class="dropdown">
    ...
    <div
      tabindex="0"
      class="dropdown-content -left-6 w-80 menu shadow bg-base-300 rounded-box overflow-auto"
    >
      <!-- rest -->
      <div
      ...
      <div
        ...
        class="px-4 py-2 w-full hover:bg-gray-100 dark:hover:bg-[#393939] cursor-pointer"
        :key="index"
