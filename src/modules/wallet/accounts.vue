...
<template>
  <div>
    <div class="overflow-x-auto w-full rounded-md">
      <div class="flex flex-wrap justify-between bg-base-300 p-5">
        <div class="min-w-0">
    ...
    <div class="overflow-x-auto">
      <div v-for="{ key, subaccounts } in accounts" class="bg-base-300 rounded-md my-5 py-5">
        <div class="flex justify-self-center">
          ...
          <div>
            ...
            <div class="dropdown">
              ...
              <ul tabindex="0" class=" -left-14 dropdown-content menu p-2 shadow bg-base-300 rounded-box z-50">
        ...
        <div class="p-4 bg-base-300 mt-2">Delegations</div>
        <div>
        ...
        <div class="p-4 bg-base-300">Balances</div>
        <div>
          <ul class="!menu w-full">
      ...
      <div class=" text-center bg-base-300 rounded-md my-4 p-4">
    ...
    <div class="modal" id="address-modal">
      <div class="modal-box">
        ...
        <div class="modal-action mt-2 mb-0">
          <a href="#" class="btn btn-orange-300 btn-sm" @click="importStep = 'step1'">Close</a>
        </div>
      </div>
    </div>
  </div>
