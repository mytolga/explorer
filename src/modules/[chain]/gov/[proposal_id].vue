    ...
    <div class="gap-4 mb-4 grid lg:!!grid-cols-3 auto-rows-max">
      ...
      <div class="bg-base-300 px-4 pt-3 pb-4 rounded shadow">
        ...
        <div class="mt-6 grid grid-cols-2">
          <label
            for="vote"
            class="btn btn-orange-300 float-right btn-sm mx-1"
      ...
      <div class="bg-base-300 px-4 pt-3 pb-5 rounded shadow lg:!!col-span-2">
        ...
        <div class="px-1">
          ...
          <div class="flex items-center mb-4">
            <div class="w-2 h-2 rounded-full bg-black mr-3"></div>
            <div class="text-base flex-1 text-main">
              {{ $t('gov.deposited_at') }}:
              {{
                format.toDay(
