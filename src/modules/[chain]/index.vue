...
<template>
  <div>
    <div v-if="coinInfo && coinInfo.name" class="bg-base-300 rounded shadow mb-4">
        ...
        <div class="col-span-2 md:col-span-1">
          ...
          <div class="my-4 flex flex-wrap items-center">
            <a v-for="(item, index) of comLinks" :key="index" :href="item.href"
              class="link link-primary px-2 py-1 rounded-sm no-underline hover:text-primary hover:bg-gray-100 dark:hover:bg-zinc-950 flex items-center">
              <Icon :icon="item?.icon" />
          ...
          <div>
            <div class="dropdown dropdown-hover w-full">
              <label>
                <div
                  class="bg-gray-100 dark:bg-[#393939] flex items-center justify-between px-4 py-2 cursor-pointer rounded">
                  <div>
              ...
              <div class="dropdown-content pt-1">
                <div class="h-64 overflow-auto w-full shadow rounded">
                  <ul class="menu w-full bg-gray-100 rounded dark:bg-[#393939]">
                    <li v-for="(item, index) in store.coinInfo.tickers" :key="index" @click="store.selectTicker(index)">
                      <div class="flex items-center justify-between hover:bg-base-300">
                        <div class="flex-1">
            ...
            <div class="flex">
              <label class="btn btn-info !px-1 my-5 mr-2" for="calculator">
      ...
      <div class="h-[1px] w-full bg-gray-100 dark:bg-[#393939]"></div>
      ...
      <div class="mx-4 flex flex-wrap items-center">
        <div v-for="tag in coinInfo.categories"
          class="mr-2 mb-4 text-xs bg-gray-100 dark:bg-[#393939] px-3 rounded-full py-1">
          {{ tag }}
        </div>
      </div>
    </div>
    ...
    <div v-if="blockchain.supportModule('governance')" class="bg-base-300 rounded mt-4 shadow">
    ...
    <div class="bg-base-300 rounded mt-4 shadow">
      ...
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 px-4 pb-6">
        <div class="bg-gray-100 dark:bg-[#393939] rounded-sm px-4 py-3">
        ...
        <table class="table table-compact w-full table-zebra">
          ...
          <tbody>
            <tr v-for="(item, index) in walletStore.delegations" :key="index">
              ...
              <td>
                <div>
                  <label for="delegate" class="btn !btn-xs !btn-info btn-ghost rounded-sm mr-2"
                    @click="dialog.open('delegate', { validator_address: item.delegation.validator_address }, updateState)">
                    {{ $t('account.btn_delegate') }}
                  </label>
                  <label for="withdraw" class="btn !btn-xs !btn-info btn-ghost rounded-sm"
      ...
      <div class="grid grid-cols-3 gap-4 px-4 pb-6 mt-4">
        <label for="PingTokenConvert" class="btn btn-info text-white">{{ $t('index.btn_swap') }}</label>
    ...
    <div class="bg-base-300 rounded mt-4">
      <div class="px-4 pt-4 pb-2 text-lg font-semibold text-main">
    ...
    <div v-if="!store.coingeckoId" class="bg-base-300 rounded mt-4">
      <div class="px-4 pt-4 pb-2 text-lg font-semibold text-main">
        {{ $t('index.node_info') }}
      </div>
