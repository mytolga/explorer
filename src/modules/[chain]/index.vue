  ...
  <div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 p-4">
        <div class="col-span-2 md:col-span-1">
          ...
          <div>
            ...
            <div class="flex">
              <label class="btn btn-orange-300 !px-1 my-5 mr-2" for="calculator">
    ...
    <div class="bg-base-300 rounded mt-4 shadow">
        ...
        <table class="table table-compact w-full table-zebra">
          ...
          <tbody>
            <tr v-for="(item, index) in walletStore.delegations" :key="index">
              ...
              <td>
                <div>
                  <label for="delegate" class="btn !btn-xs !btn-orange-300 btn-ghost rounded-sm mr-2"
                    @click="dialog.open('delegate', { validator_address: item.delegation.validator_address }, updateState)">
                    {{ $t('account.btn_delegate') }}
                  </label>
                  <label for="withdraw" class="btn !btn-xs !btn-orange-300 btn-ghost rounded-sm"
      ...
      <div class="grid grid-cols-3 gap-4 px-4 pb-6 mt-4">
        <label for="PingTokenConvert" class="btn btn-orange-300 text-white">{{ $t('index.btn_swap') }}</label>
