...
<template>
    <div>
        <div v-if="tx.tx_response" class="bg-base-300 px-4 pt-3 pb-4 rounded shadow mb-4">
                ...
                <table class="table text-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <RouterLink :to="`/${props.chain}/block/${tx.tx_response.height}`" class="text-orange-500 dark:invert">{{ tx.tx_response.height
                                }}
                                </RouterLink>
                            </td>
                        </tr>
        ...
        <div v-if="tx.tx_response" class="bg-base-300 px-4 pt-3 pb-4 rounded shadow">
