...
<template>
  <div>
    <!--  -->
    <div class="bg-base-300 px-4 pt-3 pb-4 rounded shadow">
    ...
    <div class="mt-4" v-if="roundState['height/round/step']">
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 pb-4">
        <div
          class="bg-base-300 px-4 py-3 rounded shadow flex justify-between items-center"
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-orange-300 text-neutral-content rounded-full w-12 h-12"
            >
        ...
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-orange-100 text-neutral-content rounded-full w-12 h-12"
            >
        ...
        >
          ...
          <div class="avatar placeholder">
            <div
              class="bg-amber-100 text-neutral-content rounded-full w-12 h-12"
            >
              <span class="text-2xl text-orange-500 font-semibold">{{ $t('consensus.r') }}</span>
            </div>
          </div>
        </div>
        <!-- Step -->
    ...
    <!-- update -->
    <div
      class="bg-base-300 p-4 rounded shadow"
    ...
    >
      ...
      <div class="flex flex-col md:!flex-row">
        <div class="flex mr-1 mb-1">
          <div class="px-4 w-[34px] h-6 rounded-lg bg-black"></div>
        ...
        <div class="flex mr-1 mb-1">
          <div class="px-4 w-[34px] h-6 rounded-lg bg-gray-950"></div>
