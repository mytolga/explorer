...
<template>
<div>
    <div class="bg-base-300 rounded-lg grid sm:grid-cols-1 md:grid-cols-4 p-4" >    
        <div class="flex">
            <span>
                ...
                <table class="table staking-table w-full">
                    ...
                    <tbody>
                        <tr
                            ...
                            class="hover:bg-gray-100 dark:hover:bg-[#393939]"
                        >
                            <!-- 👉 rank -->
                            <td>
                                <div
                            ...
                            <td class="text-center">
                                ...
                                <label
                                    v-else
                                    for="delegate"
                                    class="btn btn-xs btn-orange-300 rounded-sm capitalize"
                                    @click="
